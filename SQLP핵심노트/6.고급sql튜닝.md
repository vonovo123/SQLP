...
a.같은 SQL을 여러 번 수행할 때 바인드 변수를 사용하면 Parse Call은 한 번만 일어난다.
...
은행입금내역 테이블에서 입금일시가 '20210329' 인 고객의 고객별 총입금액을 가지고
...
```sql
to_char(입금일시, 'yyyymmdd') = '20210329'
to_number(수납일자) = 20210329
```
